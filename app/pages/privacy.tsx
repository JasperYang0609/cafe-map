...
const CONTENT_KO = {
  ...
  sections: [
    ...
    {
      title: '6. 아동 개인정보',
      body: '본 서비스는 만 13세 미만 아동을 대상으로 하지 않습니다.',
    },
  ],
};
...
const CONTENT_TH = {
  ...
  contact: 'สอบถาม: support@ansai.tw',
  sections: [
    {
    ...
    },
    {
      ...
      body: 'บริการนี้ไม่ได้มุ่งเป้าไปที่เด็กอายุต่ำกว่า 13 ปี',
    },
  ],
};
